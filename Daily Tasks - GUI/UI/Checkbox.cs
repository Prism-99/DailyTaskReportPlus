...
namespace DailyTasksReport.UI
{
    internal class Checkbox : OptionsElement
    {
        ...
        public Checkbox(string label, OptionsEnum whichOption, TaskReportConfig config, int itemLevel = 0) :
        ...
        public Checkbox(string label, OptionsEnum whichOption, TaskReportConfig config, bool hasBubbleButton, int slotWidth) :
        ...
        internal void RefreshStatus()
        {
            switch (_option)
            {
                ...
                case OptionsEnum.UnharvestedCrops:
                    ...
                    break;
                case OptionsEnum.SkipFlowers:
                    _isChecked = _config.SkipFlowersInHarvest;
                    break;
        ...
        public override void receiveLeftClick(int x, int y)
        {
            ...
            switch (_option)
            {
                ...
                case OptionsEnum.SkipFlowers:
                    _config.SkipFlowersInHarvest = _isChecked;
                    break;

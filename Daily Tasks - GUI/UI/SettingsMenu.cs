...
namespace DailyTasksReport.UI
{
    internal class SettingsMenu : IClickableMenu
    {
        ...
        private SettingsMenu(ModEntry parent, int currentIndex = 0) :
            base((int)(Game1.viewport.Width *Game1.options.zoomLevel / 2) - Game1.tileSize * 10 / 2,
                (int)(Game1.viewport.Height * Game1.options.zoomLevel / 2) - Game1.tileSize * 8 / 2,
                Game1.tileSize * 10,
                Game1.tileSize * 8,
                true)
        {
            ...
            _options.Add(new Checkbox("Skip Unharvested flowers", OptionsEnum.SkipFlowers, parent.Config));
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            var yTitleOffset = (int)(SpriteText.getHeightOfString("Daily Tasks Plus Report Settings") * 1.6);
            SpriteText.drawStringWithScrollCenteredAt(b, "Daily Tasks Plus Settings", xPositionOnScreen + width / 2,
        ...
        {
            ReportConfigChanged?.Invoke(null, EventArgs.Empty);
        }
    }
}